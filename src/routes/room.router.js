...
router.get("/", getRooms) // get all room
router.post("/create", validate(createRoomSchema) ,  createRoom) // create room
...
router.delete("/:room/members/:member", validate(deleteMemberSchema) , deleteMember) // delete member from the room
